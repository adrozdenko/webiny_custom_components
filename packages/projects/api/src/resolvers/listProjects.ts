...
import { ApplicationContext, ListResolverResponse, ListProjectsArgs, Project } from "../types";
...
/**
 * Listing projects is using Elasticsearch only.
...
): Promise<ListResolverResponse<Project>> => {
