...
/* Custom element plugins for Page Builder */
import iFrameElementPlugins from "iframe/render";
import linkElementPlugins from "link/render";
export default [
    // iFrame element plugins
    iFrameElementPlugins(),
    // link element plugins
    linkElementPlugins(),
    linkPreload(),
    // Page elements
    document(),
